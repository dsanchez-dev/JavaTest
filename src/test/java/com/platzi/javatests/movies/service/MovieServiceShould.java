...
public class MovieServiceShould {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.when(movieRepository.findAll()).thenReturn(
                Arrays.asList(
                        ...
                        new Movie(7, "Matrix", 136, Genre.ACTION, "Lana Wachowski")
                )
        );

        Mockito.when(movieRepository.findByDirector("Christopher Nolan")).thenReturn(
                Arrays.asList(
                        new Movie(1, "Dark Knight", 152, Genre.ACTION, "Christopher Nolan"),
                        new Movie(2, "Memento", 113, Genre.THRILLER, "Christopher Nolan")
                )
    ...
    public void return_movies_by_director() {
        ...
        assertThat(getIntegers(movies), CoreMatchers.is(Arrays.asList(1, 2)));
    }
